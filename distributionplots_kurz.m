function [] = distributionplots_kurz(location, yyyy, mon, dd, tw_mean_d, t_mean_d,rel_mean_d, press, tw_longterm_oct, tw_longterm_nov, tw_longterm_dec, tw_longterm_jan, tw_longterm_feb, tw_longterm_mar, tw_longterm_apr, U)
...
dlmwrite(filename2,data_all,'delimiter', ' ' , 'newline', 'pc');
   ...
   m7= figure('name','Distribution of Tw')
    ...
    subplot(4,2,1)
 %  plot(xioct2, foct2, 'b', xioct3, foct3, 'k--','linewidth',2,  xioct4, foct4, 'r--','linewidth',2)%
    ...
    subplot(4,2,2)
    %plot(xinov1,fnov1, 'g','linewidth',2, xinov2, fnov2, 'b','linewidth',2, xinov3, fnov3, 'k--','linewidth',2,  xinov4, fnov4, 'r--','linewidth',2)%
    ...
    subplot(4,2,3)
    %plot(xidec1,fdec1, 'g','linewidth',2, xidec2, fdec2, 'b','linewidth',2, xidec3, fdec3, 'k--','linewidth',2,  xidec4, fdec4, 'r--','linewidth',2)%
    ...
    subplot(4,2,4)
    %plot(xijan1,fjan1, 'g','linewidth',2, xijan2, fjan2, 'b','linewidth',2, xijan3, fjan3, 'k--','linewidth',2,  xijan4, fjan4, 'r--','linewidth',2)%
    ...
    subplot(4,2,5)
    %plot(xifeb1,ffeb1, 'g','linewidth',2, xifeb2, ffeb2, 'b','linewidth',2, xifeb3, ffeb3, 'k--','linewidth',2,  xifeb4, ffeb4, 'r--','linewidth',2)%
    ...
    subplot(4,2,6)
    %plot(ximar1,fmar1, 'g','linewidth',2, ximar2, fmar2, 'b','linewidth',2, ximar3, fmar3, 'k--','linewidth',2,  ximar4, fmar4, 'r--','linewidth',2)%
   ...
   set(h, 'linewidth', 2);
    ...
    subplot(4,2,7)
    %plot(xiapr1,fapr1, 'g','linewidth',2, xiapr2, fapr2, 'b','linewidth',2, xiapr3, fapr3, 'k--','linewidth',2,  xiapr4, fapr4, 'r--.','linewidth',2)%
    ...
    legend('1994-2014', 'Zeitraum 1994-2014 plus mögliche Klimaänderung bis 2030', 'Zeitraum 1994-2014 plus mögliche Klimaänderung bis 2050');
