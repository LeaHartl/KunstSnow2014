...
%==========================================================================
% Daten einlesen
file1=fopen('snow\SnowHPeissenberg\HPeissenbergSnow.out');
C=textscan(file1, '%f %f %f %f', 'headerlines',0);
fclose(file1);

file2=fopen('snow\SnowHPeissenberg\twprobyearHoPeissenberg.out');
...
file3=fopen('snow\SnowHPeissenberg\twprobyearlast20HoPeissenberg.out');
...
%     text(xpos(1),ymittl+2,['Stabw.: ',num2str(roundn(nanstd(diff_clim_count_SH30),-1)),' Tage'],'fontweight','bold','BackgroundColor','none','Fontsize',12);  
...
%     text(xpos(1)+40,ymittl+2,['T/R.: ',num2str(roundn((Tr_max2),-2)),' (',num2str(datestr(jan_15(xxxcount2))),'/',num2str(datestr(jan_15(xxxcount2+1))),' - ',num2str(datestr(jan_15(end-1))),'/',num2str(datestr(jan_15(end))),')'],'fontweight','bold','BackgroundColor','none','Fontsize',12); 
%     if Tr_max2>1.64
...
%     
% saveas(m1234, 'fig4Snow.jpg');
% saveas(m1234, 'fig4Snow.fig');
% %  
% 
% 
% 
...
%     hold on
%     hline11= plot(date_year, SH_prob_year_last20(:,1))
%     set(hline11,'LineWidth', 2, 'Color',[1 105/255 180/255] )
%     hold on
...
%     alpha(.5)
%     hold on
%     hline22= plot(date_year, tw_prob_year_last20(:,1))
%     set(hline22,'LineWidth', 2, 'Color',[0.2 0.2 0.2] )
%     grid off
%     %axes(haxes(1))
%     set(gca,'fontsize',14)
...
%     axis tight
%    
%     legend('Schneehöhe \geq 30 cm, ganze Zeitreihe','Schneehöhe \geq 30 cm, 1993-2014', 'Tagesmittel Tf \leq -2°C, ganze Zeitreihe', 'Tagesmittel Tf \leq -2°C, 1993-2014')
...
size(SH_winter)
 ...
 hline =line([datenum(1999+1,1,15,0,0,0), datenum(1999+1,1,15,0,0,0)], ylim, 'Color', 'k', 'linewidth', 2);
 %hline2 =line([datenum(1998+1,1,15,0,0,0), datenum(1998+1,1,15,0,0,0)], ylim, 'Color', 'k', 'linewidth', 2);
     set(gca,'fontsize',14)
     axis tight
     xlabel('Jahre')
     grid on
